package com.AnuragKonark.MoodLift.tracker;
...
import com.AnuragKonark.MoodLift.tracker.database.AppDatabase;
import com.AnuragKonark.MoodLift.tracker.database.Mood;
import com.AnuragKonark.MoodLift.tracker.database.MoodDao;
import com.AnuragKonark.MoodLift.tracker.database.Resources;
import com.AnuragKonark.MoodLift.tracker.database.ResourcesDao;
import com.AnuragKonark.MoodLift.tracker.intro.IntroActivity;
import com.AnuragKonark.MoodLift.tracker.notification.AlarmReceiver;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if (isTaskRoot()){
            this.startActivity(new Intent(MainActivity.this, HomeActivity.class));
        }
        finish();
    }
}